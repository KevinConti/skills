...
This skill uses `Bash` to run the Python script and `Read` for inspecting output files. All operations are **read-only** — no emails are sent, modified, or deleted.
